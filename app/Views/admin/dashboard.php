...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <!-- Mensajes no leídos -->
    <a href="/admin/contacto" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
    ...
    <!-- Total usuarios -->
    <a href="/admin/usuarios" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
    ...
    <!-- Ir al sitio -->
    <a href="/" target="_blank" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
